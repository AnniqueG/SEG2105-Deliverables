...
public class MyDBHandlerCourse extends SQLiteOpenHelper{
    ...
    private static final String COLUMN_HAS_INSTRUCTOR = "has"; //Index 2?
    ...
    public void onCreate(SQLiteDatabase db){
        String CREATE_USERS_TABLE = "CREATE TABLE " + TABLE_COURSES + "(" + COLUMN_ID +
                " INTEGER PRIMARY KEY," + COLUMN_NAME + " TEXT," + COLUMN_CODE + " DOUBLE," + COLUMN_HAS_INSTRUCTOR + " TEXT" +
                ")";
    ...
    public void addCourse(Course course){
        ...
        values.put(COLUMN_HAS_INSTRUCTOR, "false");
    ...
    public void addCourseInst(Course course){
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(COLUMN_NAME, course.getCourseName());
        values.put(COLUMN_CODE, course.getCourseCode());
        values.put(COLUMN_HAS_INSTRUCTOR, "true");
