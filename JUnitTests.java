...
//    }
    ...
    public void testLookupCourseCourseDB(){
        ...
        assertEquals(course, success.lookupCourseCourseDB(course.getCourseName()));
    }
    ...
    public void testLookupCourseCodeCourseDB(){
        ...
        StudentSuccessActivity success = new StudentSuccessActivity();
        assertEquals(course, success.lookupCourseCodeCourseDB(course.getCourseCode()));
    }
    ...
    public void testLookupCourseDayCourseDB(){
        ...
        StudentSuccessActivity success = new StudentSuccessActivity();
        assertEquals(course,success.lookupCourseDayCourseDB(course.getDays()));
    }
